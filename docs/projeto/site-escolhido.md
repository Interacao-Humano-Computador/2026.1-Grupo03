...
Agradecimento ao Google Gemini pela ajuda na construção técnica e escrita da página.

## Histórico de versão

| Versão | Data       | Descrição                              | Autor         | Revisor |
| ------ | ---------- | -------------------------------------- | ------------- | ------- |
| 1.1    | 12/04/2026 | Inclusão da seção "O que o Procon faz" | Pedro Augusto Moretti Moreira | Heitor Macedo |
| 1.0    | 10/04/2026 | Criação do documento                   | Pedro Augusto Moretti Moreira | Heitor Macedo |
