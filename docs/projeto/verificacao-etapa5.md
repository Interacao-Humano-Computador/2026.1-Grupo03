...
* **Dados Objetivos:** Dados coletados na avaliação que podem ser medidos diretamente por instrumentos ou software, sem depender da opinião do usuário (ex: tempo gasto numa tarefa, quantidade de cliques ou número de erros cometidos) [(Barbosa et al., 2021, p. 255)](images/verificacao5/dadosobjetivos.png).

* **Dados Subjetivos:** Informações que precisam ser explicitamente expressas pelos participantes da avaliação, refletindo suas opiniões, sentimentos, dores e preferências (geralmente capturados através de questionários, think aloud ou entrevistas) [(Barbosa et al., 2021, p. 255)](images/verificacao5/dadossubjetivos.png).

* **Dados Qualitativos:** Dados focados na interpretação de conceitos e comportamentos, buscando explorar e explicar o *porquê* e *como* certas dificuldades ocorreram durante a interação do usuário com o sistema [(Barbosa et al., 2021, p. 255)](images/verificacao5/dadosqualitativos.png).

* **Dados Quantitativos:** Dados focados puramente na contagem, medição de quantidades e estatísticas extraídas do desempenho dos usuários nas sessões de teste [(Barbosa et al., 2021, p. 255)](images/verificacao5/dadosquantitativos.png).
...
|:--:|:---|:---:|:---:|:---:|:---|
| **D5-01** | O histórico de versão está padronizado? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
| **D5-02** | O(s) autor(es) e o(s) revisor(es) estão identificados para cada artefato? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
| **D5-03** | Todos os artefatos possuem referências bibliográficas e/ou bibliografia? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
| **D5-04** | As tabelas e imagens possuem legenda e fonte, e são chamadas dentro do texto? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
| **D5-05** | Existe um texto introdutório apresentando os artefatos? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
| **D5-06** | O cronograma executado indica quem realizou cada artefato/atividade, com datas de início e fim da construção/realização? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
| **D5-07** | Há ata(s) da(s) reunião(ões) com data, horário de início e fim, participantes, objetivo e atividades definidas? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
| **D5-08** | Há gravação da reunião do grupo? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
| **D5-09** | Existe vídeo de apresentação publicado no YouTube na categoria "não listado"? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
...
| **D5-11** | O artefato possui seção de agradecimentos apresentando o uso de Inteligência Artificial (IA) Generativa? | <span style="background-color: #1976d2; color: white; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">Sugestão do Professor</span> | Professor |  | |
