...
| ------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ------------- |
| 1.2    | 12/04/2026 | Inclusão de imagens de referência para os modelos de ciclo de vida e para o processo de design de Nielsen, com legendas e referências bibliográficas padronizadas.                                                                                       | Pedro Moretti         |               |
