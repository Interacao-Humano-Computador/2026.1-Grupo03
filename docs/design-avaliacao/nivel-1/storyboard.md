...
* **As pessoas envolvidas** (Atores/Personas);
* **Ambiente/contexto** (Onde a ação ocorre);
* **A motivação** para usar o sistema;
* **As tarefas e os passos envolvidos**;
* **O que as pessoas precisam fazer** para completar a tarefa;
* **A satisfação da pessoa** ao completar a tarefa, no final da narrativa.

---

## 2. Storyboards do PROCON-DF
Como resultado da nossa análise de tarefas, a equipe desenvolveu 7 storyboards (um para cada integrante), visando explorar as principais funcionalidades propostas para a solução do novo sistema do PROCON-DF.

### 2.1. Tarefa 1: Acompanhamento de Reclamação via Notificação Ativa
...
**Autor:** Pedro Augusto Moretti Moreira
...
Agradecimento ao **Gemini** pela ajuda na estruturação deste documento e criação das imagens.
