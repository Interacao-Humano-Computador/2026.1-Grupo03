...
<div align="center"><p><i>Fonte: Protótipo HTML gerado por Claude (Anthropic). Esboços de papel por Pedro Moretti.</i></p></div>
...
Agradecimento ao **DeepSeek** pela ajuda na estruturação e formatação deste documento, incluindo a organização das figuras em padrão ABNT e a padronização das seções.
