...
| Autores | Contribuiu |
|---|---|
| Pedro Augusto Macedo | Elaborou o Artefato |
...
| Mateus Rodrigues | [Funcionalidades](../analise-requisitos/funcionalidades.md), [Metas de Usabilidade](../analise-requisitos/metas-usabilidade.md), [Storyboard](../design-avaliacao/nivel-1/storyboard.md), [Protótipo de Papel](../design-avaliacao/nivel-2/prototipos-papel.md), [Relato dos Resultados do Protótipo de Papel](../design-avaliacao/nivel-2/relato-resultados-prazos.md), [Protótipo de Alta Fidelidade](../design-avaliacao/nivel-3/prototipo-alta-fidelidade-painel-prazos.md) e [Relato dos Resultados do Protótipo de Alta Fidelidade](../design-avaliacao/nivel-3/relato-resultados-alta-fidelidade-painel-prazos.md) | 7 |
...
| 1.1 | 01/07/2026 | Correção de caminhos de links, conversão dos itens restantes em links markdown e adição do bloco de Colaboração. | Heitor Macedo Ricardo | Pedro Augusto Moretti Moreira |