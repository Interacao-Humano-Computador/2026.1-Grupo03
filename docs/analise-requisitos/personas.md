...
O elenco de personas deste projeto foi construído a partir dos dados coletados no Perfil de Usuário, com base nos resultados do Grupo de Foco realizado em 30/04/2026 e nos questionários demográficos aplicados previamente. O elenco é composto por **3 personas** ao total: **2 personas primárias**, **1 persona secundária** e **1 antipersona**.
