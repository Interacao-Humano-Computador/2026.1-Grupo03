...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **0.0** Acompanhar reclamação e responder à proposta da empresa (objetivo geral) | Usuário autenticado; processo aberto com proposta da empresa disponível; notificação proativa enviada | Sequência: 1 >> 2 >> 3 (obrigatória) | Decisão do usuário registrada (aceite ou recusa); e-mail de confirmação enviado; status do processo atualizado | Usuário ignora notificação; proposta não compreendida; abandono do processo | Canal preferido do usuário (WhatsApp); linguagem simples; confirmação explícita antes de cada ação irreversível |
| **1.** Acessar o portal via notificação ativa | Notificação proativa enviada (WhatsApp/SMS/e-mail); dispositivo com acesso à internet | Sequência: 1.1 >> 1.2 | Painel do processo carregado com status e proposta visíveis | Notificação ignorada; link expirado; sessão com timeout curto | Usar canal preferido do usuário; mensagem com nome e protocolo; links com validade mínima de 7 dias |
| **1.1** Receber e ler a notificação proativa (WhatsApp/SMS/e-mail) | Notificação enviada pelo sistema; número de protocolo e nome do usuário disponíveis | Sistema envia mensagem com link seguro e resumo da situação; usuário lê a notificação | Mensagem exibida com nome, protocolo e link clicável; leitura confirmada | Notificação pode cair em spam ou ser ignorada | Usar WhatsApp como canal principal; mensagem objetiva com protocolo e identificação do usuário |
| **1.2** Tocar no link seguro da notificação para abrir o painel | Link ativo com token de autenticação; dispositivo com browser | Usuário toca no link → sistema valida token → painel do processo é aberto | Painel carregado exibindo status atual do processo e resumo da proposta | Link expirado; tempo de sessão muito curto | Links com validade mínima de 7 dias; autenticação simplificada por token, sem necessidade de senha |
| **2.** Interpretar o status e a proposta da empresa | Painel aberto; linha do tempo e resumo da proposta disponíveis | Sequência: 2.1 >> 2.2 | Usuário consegue compreender o status e a proposta sem necessidade de ajuda externa | Jargões jurídicos; proposta longa ou técnica | Linguagem simples e direta; resumo automático em até 3 linhas; exemplos concretos de prazos |
| **2.1** Visualizar a linha do tempo do processo | Status do processo atualizado; histórico de eventos disponível no sistema | Sistema exibe cronologia visual com etapas concluídas e pendentes em linguagem simples | Linha do tempo renderizada com ícones de status; prazos legíveis; sem termos técnicos | Uso de jargões jurídicos (ex.: "manifestação do fornecedor") confunde usuários leigos | Linguagem simples e direta; exemplos concretos de prazo (ex.: "A empresa tem 5 dias para responder") |
| **2.2** Ler o resumo da proposta em linguagem simples | Proposta da empresa registrada no sistema; campo de resumo automático gerado | Sistema exibe resumo em até 3 linhas com valor e condição; usuário lê e avalia | Usuário lê e compreende a proposta; decide se aceita ou recusa | Proposta longa ou técnica pode levar ao abandono | Sistema gera resumo automático destacando valor e condição da proposta; botão de "Ver proposta completa" disponível |
| **3.** Registrar decisão sobre a proposta | Usuário autenticado; proposta lida; botões de ação visíveis | Seleção exclusiva: [3.1] ou [3.2] | Decisão registrada; status do processo atualizado; e-mail de confirmação enviado | Usuário pode aceitar/recusar sem entender as implicações | Aviso claro antes de confirmação de ação irreversível; mensagem explicando o próximo passo após cada decisão |
| **3.1** Aceitar a proposta da empresa | Proposta exibida; usuário decide aceitar | Usuário clica em "Aceitar" → sistema exibe aviso de encerramento → usuário confirma → sistema registra aceite | Mensagem "Processo encerrado com acordo" exibida; notificação enviada à empresa; e-mail enviado ao usuário | Usuário pode aceitar sem entender que o processo será encerrado definitivamente | Exibir aviso claro: "Ao aceitar, o processo será encerrado e não poderá ser reaberto." Requerer confirmação explícita |
...
| **4.1** Revisar e assinar digitalmente o termo de acordo gerado pelo mediador | Termo de acordo exibido na tela; certificado digital Gov.br. | Sistema exibe o termo; usuário revisa, clica em “Assinar”, autentica via Gov.br; sistema registra e encerra. | Assinatura confirmada; PDF do termo enviado por e‑mail e disponível no portal. | Usuário não possui conta Gov.br; não entende validade jurídica. | Botão “Assinar com Gov.br” com tutorial rápido; mensagem de validade jurídica. |
