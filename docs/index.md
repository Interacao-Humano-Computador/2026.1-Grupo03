...
# 📊 Gestão e Acompanhamento de Entregas
...
=== "Etapa 1"
    ...
    | **Artefatos de Validação**<br>*(Construção da Lista de Verificação)* | [Heitor](equipe/equipe.md), [Heloísa](equipe/equipe.md) & [Eduardo](equipe/equipe.md) | [Moretti](equipe/equipe.md) | [📦 Commit Github](#) <br> *(Página PENDENTE)* | ⏳ Em Andamento |
